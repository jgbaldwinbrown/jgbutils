...
datapath="dsbig_fused_xtx_and_bf_5combo_withchroms_2sorted_cens_withhead_uniq_multiwin_plusxtx.RDS"
threshpath="bf_thresh_11pop.txt"
threshpath_win="bf_thresh_11pop_25win.txt"
...
pcol2 = paste("bf",as.character(index),"_win25",sep="")
  ...
  tiff(paste(c("/home/jbaldwin/new_home/wild_shrimp_data/for_shrimp_paper_1/bwa_alignments/snp_tables/deduped/new_downsampled/full_fst_dsbig_fused/bayenv_5repavg/v4_full_data_fixedinput_splitout/bf_all_plots/",outpref,"_25win.tif"),collapse=""),
