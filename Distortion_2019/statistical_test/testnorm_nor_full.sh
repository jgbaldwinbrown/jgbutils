...
Rscript normal_nor_full.R -o normal_nor_full_out1.txt -O normal_nor_full_out2.txt -p normal_nor_full_plot1.pdf -P normal_nor_full_plot2.pdf binom_testdat.txt  
