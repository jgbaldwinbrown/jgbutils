...
# make sure the correct things are factors
...
#l = glm(data, formula = count ~ gc*indiv*tissue | pos, family="poisson")
l = glmer(data = data, formula = count ~ tissue + gc*sample*chrom + (1 | pos), family="poisson")
