...
Rscript normal_win_nor.R -o normal_nor_winout1.txt -O normal_nor_winout2.txt -p normal_nor_winplot1.pdf -P normal_nor_winplot2.pdf binom_testdat.txt  -w 100 -s 10 -t normal_nor_winout3.txt
