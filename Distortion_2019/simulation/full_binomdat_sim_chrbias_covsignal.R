...
# make sure 1 region of the genome is selected, and give it a bias toward higher coverage
...
new2_ab$count[selectedrange] = rpois((selectedend - selectedstart) + 1, rep(avgcov, nrow(new2_ab[selectedrange,])) + new2_ab$bias[selectedrange] + new2_ab$sample_gc_bias[selectedrange] + (avgcov * distortion_frac))
