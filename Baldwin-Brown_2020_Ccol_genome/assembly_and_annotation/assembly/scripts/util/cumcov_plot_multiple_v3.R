...
sorted_data <- c(sorted_data1,sorted_data2,sorted_data3,sorted_data4)
mycumsum <- c(mycumsum1,mycumsum2,mycumsum3,mycumsum4)
idents <- c(rep("Canu assembly v2",length(sorted_data1)),rep("Canu assembly v1",length(sorted_data2)),rep("CLC assembly v1",length(sorted_data3)),rep("Canu assembly v3",length(sorted_data4)))
