...
mkdir -p temp/binner/binner_practice

/data1/jbrown/local_programs/Taxonomer_from_aurelie/Taxonomer_201602/bin_reads scripts/binner/louse.raw.180.wd_binned.out_0.3.wd-binner_mini_test.conf -c 0.3 >  temp/binner/binner_practice/louse.raw.180.wd_binned.out_0.3.wd-binner.log 2>&1
