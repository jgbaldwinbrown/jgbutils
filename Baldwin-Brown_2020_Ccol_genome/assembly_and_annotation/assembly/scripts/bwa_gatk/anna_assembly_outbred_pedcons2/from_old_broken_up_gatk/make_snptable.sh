...
perl scripts/bwa_gatk/anna_assembly_outbred/align/run1/snptable_8sigfig.pl 1 1 <${HOMEPATH}/data/gatk/only-PASS-Q30-SNPs.vcf >${HOMEPATH}/data/snp_tables/only-PASS-Q30-SNPs.txt
perl scripts/bwa_gatk/anna_assembly_outbred/align/run1/snptable_8sigfig.pl 1 1 <${HOMEPATH}/data/gatk/only-PASS-Q30-INDEL.vcf >${HOMEPATH}/data/snp_tables/only-PASS-Q30-INDEL.txt
