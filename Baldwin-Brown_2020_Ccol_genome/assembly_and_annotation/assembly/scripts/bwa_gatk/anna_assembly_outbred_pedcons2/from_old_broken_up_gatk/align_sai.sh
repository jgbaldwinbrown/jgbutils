...
cat scripts/bwa_gatk/anna_assembly_outbred/align/run1/fdatapaths.txt | xargs cat > $FDATAPATH
RDATAPATH=${HOMEPATH}/fdata_full/rdata.fq
cat scripts/bwa_gatk/anna_assembly_outbred/align/run1/rdatapaths.txt | xargs cat > $RDATAPATH
