with open("temp/platanus/fqjoin_180_paths_unfiltered.txt") as file:
  paths_180bp = file.readlines()

with open("temp/platanus/fqjoin_500_paths_unfiltered.txt") as file:
...
print "#$ -R Y"
print "#$ -q bio,pub64"
print "#platanus assemble -t 32 -f " + all_short_string + " -o " + outpath +"plat_assembly_unfiltered -m 512 1> " + outpath + "plat_assembly_unfiltered_out.txt 2> " + outpath + "plat_assembly_unfiltered_err.txt"
print ""
print "platanus scaffold -t 32 -c " + outpath + "plat_assembly_unfiltered_contig.fa -b " + outpath + "plat_assembly_unfiltered_contigBuggle.fa " + all_180bp_scaf_string + all_500bp_scaf_string + all_3500bp_scaf_string + all_8200bp_scaf_string + " 1> " + outpath + "plat_scaffold_unfiltered_out.txt 2> " + outpath + "plat_scaffold_unfiltered_err.txt"
print ""
print "#platanus gap_close -t 32 -c " + outpath + "plat_assembly_unfiltered_contig.fa -b " + outpath + "plat_assembly_unfiltered_contigBuggle.fa " + all_180bp_gap_string + all_500bp_gap_string + all_3500bp_gap_string + all_8200bp_gap_string + " 1> " + outpath + "plat_gapclose_unfiltered_out.txt 2> " + outpath + "plat_gapclose_unfiltered_err.txt"
print ""
