...
-s 3000M \
-t 64 \
-o pero_ill_mer_counts.jf \
-C \
<(zcat ../../data/illumina/1/R231-L1-READ1-Sequences.txt.gz) \
<(zcat ../../data/illumina/1/R231-L1-READ2-Sequences.txt.gz) \
<(zcat ../../data/illumina/2/R235-L2-READ2-Sequences.txt.gz) \
<(zcat ../../data/illumina/2/R235-L3-READ2-Sequences.txt.gz) \
<(zcat ../../data/illumina/2/R235-L2-READ1-Sequences.txt.gz) \
<(zcat ../../data/illumina/2/R235-L1-READ1-Sequences.txt.gz) \
<(zcat ../../data/illumina/2/R235-L3-READ1-Sequences.txt.gz) \
<(zcat ../../data/illumina/2/R235-L1-READ2-Sequences.txt.gz)
