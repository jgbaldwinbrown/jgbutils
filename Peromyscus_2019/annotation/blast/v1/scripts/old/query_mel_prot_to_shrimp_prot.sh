...
blastp -db /bio/jbaldwi1/all_data_from_dfs2/shrimp_data/blast_alignments/final_assembly_version_9-30-15/blastdb/shrimp_prot_blastdb/shrimp_prot_blastdb -query /bio/jbaldwi1/all_data_from_dfs2/shrimp_data/blast_alignments/final_assembly_version_9-30-15/drosophila/all_input/dmel-all-translation-r6.06.fasta -out ../augustus_comparisons/augustus_prot/reciprocal/dmel_prot_queried_on_shrimp_augustus_prot -evalue 1e-5 -outfmt 6 -num_descriptions 1 -num_alignments 1
