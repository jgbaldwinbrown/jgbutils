...
tblastn -db ../blastdb/shrimp_ref_blastdb/shrimp_ref_v2_nucl_db -query ../allozymes_mel/fum_protein.fa -out ../allozymes_mel/fum_protein.fa.out -evalue 1e-5 -outfmt 6 -num_descriptions 1 -num_alignments 1
