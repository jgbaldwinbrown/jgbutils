...
perl snptable.pl 12 7 <data/gatk/only-PASS-Q30-SNPs.vcf >data/snp_tables/only-PASS-Q30-SNPs.txt
perl snptable.pl 12 7 <data/gatk/only-PASS-Q30-INDEL.vcf >data/snp_tables/only-PASS-Q30-INDEL.txt
