...
perl snptable_8sigfig.pl 1 1 <data/gatk/only-PASS-Q30-SNPs.vcf >data/snp_tables/only-PASS-Q30-SNPs.txt
perl snptable_8sigfig.pl 1 1 <data/gatk/only-PASS-Q30-INDEL.vcf >data/snp_tables/only-PASS-Q30-INDEL.txt
